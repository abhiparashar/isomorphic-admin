...
const columns = [
  ...
  // },
  {
    title: <IntlMessages id='antTable.title.MicroservicesName' />,
    key: "firstName",
    width: 100,
    render: object => renderCell(object, "TextCell", "MicroservicesName")
  },
  {
    title: <IntlMessages id='antTable.title.Request' />,
    key: "lastName",
    width: 100,
    render: object => renderCell(object, "TextCell", "Request")
  },
  {
    title: <IntlMessages id='antTable.title.API' />,
    key: "city",
    width: 200,
    render: object => renderCell(object, "LinkCell", "API")
  },
  // {
